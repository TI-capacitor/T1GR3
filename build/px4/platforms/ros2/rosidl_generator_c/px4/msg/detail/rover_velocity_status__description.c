  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static rosidl_type_hash_t hash = {1, {
      0xe1, 0xd7, 0x59, 0x9f, 0x5d, 0x9c, 0x23, 0xe8,
      0xaf, 0x3b, 0x8f, 0x58, 0xcb, 0xf3, 0x08, 0x1a,
      0x33, 0x84, 0x3a, 0x90, 0x53, 0x08, 0x73, 0x8f,
      0xff, 0x8a, 0xe3, 0xab, 0xff, 0x9b, 0x28, 0xc4,
    }};
  return &hash;
}
...
static char px4__msg__RoverVelocityStatus__FIELD_NAME__speed_body_x_setpoint[] = "speed_body_x_setpoint";
...
static char px4__msg__RoverVelocityStatus__FIELD_NAME__speed_body_y_setpoint[] = "speed_body_y_setpoint";
...
static rosidl_runtime_c__type_description__Field px4__msg__RoverVelocityStatus__FIELDS[] = {
  ...
  {
    {px4__msg__RoverVelocityStatus__FIELD_NAME__speed_body_x_setpoint, 21, 21},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_FLOAT,
      0,
      0,
  ...
  {
    {px4__msg__RoverVelocityStatus__FIELD_NAME__speed_body_y_setpoint, 21, 21},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_FLOAT,
      0,
      0,
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      ...
      {px4__msg__RoverVelocityStatus__FIELDS, 9, 9},
    },
    {NULL, 0, 0},
  };
  if (!constructed) {
