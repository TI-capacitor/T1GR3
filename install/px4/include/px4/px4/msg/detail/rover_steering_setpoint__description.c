  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static rosidl_type_hash_t hash = {1, {
      0x53, 0xf6, 0x12, 0x92, 0x1c, 0x6b, 0xb8, 0x9a,
      0xc6, 0x85, 0xfc, 0xdf, 0x51, 0x71, 0xce, 0x92,
      0xd8, 0x84, 0xd5, 0xd3, 0x27, 0x50, 0xa3, 0xd2,
      0xb9, 0xed, 0x2c, 0xf1, 0x45, 0x1c, 0x79, 0x7b,
    }};
  return &hash;
}
...
static char px4__msg__RoverSteeringSetpoint__FIELD_NAME__normalized_steering_angle[] = "normalized_steering_angle";
static char px4__msg__RoverSteeringSetpoint__FIELD_NAME__normalized_speed_diff[] = "normalized_speed_diff";
...
static rosidl_runtime_c__type_description__Field px4__msg__RoverSteeringSetpoint__FIELDS[] = {
  ...
  {
    {px4__msg__RoverSteeringSetpoint__FIELD_NAME__normalized_steering_angle, 25, 25},
    {
  ...
  {
    {px4__msg__RoverSteeringSetpoint__FIELD_NAME__normalized_speed_diff, 21, 21},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_FLOAT,
      0,
      0,
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      ...
      {px4__msg__RoverSteeringSetpoint__FIELDS, 3, 3},
    },
    {NULL, 0, 0},
  };
  if (!constructed) {
